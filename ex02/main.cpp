...
/*   Updated: 2025/07/12 19:45:23 by auplisas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	(void)argc;
	(void)argv;
	std::deque<int> numbers = {343, 0, 43, 32344, 34, 7, 564, 56, 68, 99, 1, 54};
	std::deque<int> newAr = PmergeMe::conductSort(numbers);
	PmergeMe::printArray(newAr);
	return (0);
}
